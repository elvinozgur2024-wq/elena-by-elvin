  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8 lg:pt-14">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[2.5rem] bg-tint-lavender">
              <Image
                src={heroImageSrc}
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 rounded-3xl border border-border bg-card p-8 sm:grid-cols-3">
